...
#include <android_native_app_glue.h> // for the AMOTION_EVENT defines
...
void  GLTestSceneDelegate::Advance  (double predictedDisplayTime)
  {
  // NOTE:  Eventually need to update this function to use predictive time.

  // calculate the elapsed time since last update
  struct timeval  now;

  // Note: The accuracy of gettimeofday may be horrible, and need to be replaced with clock_gettime(CLOCK_REALTIME)
